...
\newcommand*{\refaunps}{\hyperlink{aunps}{\color{blue} \ttfamily AuNP Monolayers}} 
...
\hypertarget{aunps}{\section{AuNP monolayers}}

\begin{center}
\begin{tabular}{| c | c |}
 \hline
 {\bf \# Fibers AuNPs coated} & 6 \\ \hline
...
\fillin{Any particulars about the AuNP monolayers or other spetrometer notes.}
 
\hypertarget{results}{\section{Results}}

\subsection{Fiber-by-Fiber Summary}
...
\subsection{In regard to protein binding}
...
\subsection{In regard to coating}
...
\subsection{Other Conclusions/Points of interest}
...
% TOC (Have to sort of manually add it to TOC because it will put "References" twice if you make it a conventional section
\addcontentsline{toc}{section}{E\; References}
\newpage
\bibliographystyle{unsrt}
{\footnotesize\bibliography{\Dropbox Mendeley/Bibtex/library}}  %NO .bib   
